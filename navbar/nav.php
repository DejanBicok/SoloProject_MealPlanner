    ...
    <div class="container">
        <a class="navbar-brand w-10" href="index.php">
            <div class="logo d-flex flex-column align-items-start">
                <img class="logo-img-nav flex-fill w-50" src="img/tasty_food.jpg">
            </div>
        </a>
...
<div id="mySidepanel_home" class="sidepanel_home">
    <a aria-current="page" href="index.php"> Home </a>
    <a href="login.php"> Login </a>
    <a href="register.php">New to Tasty Food? Register now</a> &nbsp; &nbsp; &nbsp;
