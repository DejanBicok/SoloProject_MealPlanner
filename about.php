...
<body class="bg-light">
    ...
    <div>
        ...
        <p>Our meal planner is a handy online tool to help you plan meals ahead of time. Our meal planner generates delicious recipes for you to try over 5 or 7 days based on your likes and dislikes.
    ...
    <div>
        ...
        <p>First of all, you need to register on our website and then start by looking available recipes here: <a href="index.php" style="text-decoration:underline !important; color:rgb(174, 128, 0);"><!--Create a meal plan-->Recipe List.</a>
        ...
        <br>Then you will be able to see your Meal Planner and all recipes you've added!
        ...
        <p>Users can easily create and publish their own recipes on 'Tasty Food' and share them with other members.</p>
        <br>
